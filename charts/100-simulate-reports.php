...
class Zume_Coaching_Coaching_Types extends Zume_Coaching_Chart_Base
{
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'simulate reports', 'zume_coaching' );

        $url_path = dt_get_url_path( true );
        if ( "zume-coaching/$this->base_slug" === $url_path ) {
    ...
    public function wp_head() {
        ...
        ?>
        <script>
            window.site_url = '<?php echo site_url() ?>' + '/wp-json/zume_coaching/v1/'
            ...
            jQuery(document).ready(function(){
                ...
                chart.empty().html(`
                        <div id="zume-coaching">
                            ...
                            <table class="hover" id="datatable">
                                ...
                                <tbody class="zume-coaching-report-types"></tbody>
                            </table>
                ...
                jQuery.each( data, function( key, value ) {
                    jQuery('.zume-coaching-report-types').append(`
                            <tr>
                ...
                jQuery.get('https://zume5.training/coaching/wp-json/zume_coaching/v1/location', function(data){
                    // console.log(data)
                ...
                function makePostRequest(type, url, data, base = "zume_coaching/v1/") {
    ...
    public function data() {
        return [
            'translations' => [
                'title_overview' => __( 'Project Overview', 'zume_coaching' ),
            ],
        ];
    }
...
new Zume_Coaching_Coaching_Types();
