...
class Zume_Funnel_Events extends Zume_Funnel_Chart_Base
{
    ...
    public $base_slug = 'events'; // lowercase
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'Events', 'zume_funnels' );
        ...
        <script>
            jQuery(document).ready(function(){
                ...
                chart.empty().html(`
                        <div id="zume-funnel">
                            <div class="grid-x">
                                <div class="cell small-6"><h1>Events</h1></div>
                ...
                window.path_load = ( range ) => {
                    ...
                    // totals
                    window.spin_add()
                    makeRequest('GET', 'total', { stage: "general", key: "locations", range: range  }, window.site_info.rest_root ).done( function( data ) {
