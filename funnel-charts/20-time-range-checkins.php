...
class Zume_Funnel_Time_Range_Checkins extends Zume_Funnel_Chart_Base
{
    //slug and title of the top menu folder
    public $base_slug = 'checkintimerange'; // lowercase
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'Time Range Checkins', 'zume_funnels' );
...
new Zume_Funnel_Time_Range_Checkins();
