...
class Zume_Funnel_Coaching_Advanced extends Zume_Funnel_Chart_Base
{
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'Advanced Practitioner', 'zume_funnels' );
...
new Zume_Funnel_Coaching_Advanced();
