...
add_action( 'dt_post_updated', function ( $post_type, $post_id, $fields, $args ) {
    ...
    if ( 'contacts' === $post_type ) {
        if ( isset( $fields['contact_email'] ) ) {
            ...
            } else if (isset($fields['contact_email']['values'][0]['value'])) {
                $email = $fields['contact_email']['values'][0]['value'];
            } else {
                return;
            }
    ...
    if ( 'contacts' === $post_type ) {
        if ( isset( $fields['contact_phone'] ) ) {
            ...
            } else if (isset($fields['contact_phone']['values'][0]['value'] )) {
                $phone = $fields['contact_phone']['values'][0]['value'];
            } else {
                return;
            }
