...
/**
 * Class Zume_Coaching_Menu
 */
class Zume_Coaching_Menu {

    public $token = 'zume_coaching';
    public $page_title = 'Zume Coaching';

    private static $_instance = null;

    /**
     * Zume_Coaching_Menu Instance
     *
     * Ensures only one instance of Zume_Coaching_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Zume_Coaching_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = __( 'Zume Coaching', 'zume-coaching' );
    }
    ...
    public function register_menu() {
        ...
        add_submenu_page( 'dt_extensions', $this->page_title, 'Coaching', 'manage_dt', $this->token, [ $this, 'content' ] );
    }
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Zume_Coaching_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Zume_Coaching_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
/**
 * Class Zume_Coaching_Tab_General
 */
class Zume_Coaching_Tab_General {
    public function content() {
        ?>
    ...
    public function main_column() {
        $token = Zume_Coaching_Menu::instance()->token;
...
/**
 * Class Zume_Coaching_Tab_Second
 */
class Zume_Coaching_Tab_Second {
    public function content() {
        ?>
