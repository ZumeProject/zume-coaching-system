...
class Zume_Tile_System  {
    ...
    public function get( $post_id, $post_type ) {
        ...
        <div class="cell small-12 medium-4">
            ...
            <button class="button expanded" data-open="modal_reports">Practitioner Reports <?php echo !empty( $profile['reports'] ) ? '('. $profile['reports'] . ')': ''; ?></button>
            <button class="button expanded" data-open="modal_genmap">Current Genmap <?php echo !empty( $profile['churches'] ) ? '('. $profile['churches'] . ')': ''; ?></button>
